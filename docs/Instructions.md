...
シミュレーションにおいて，まず実世界の情報から読み込みが始まります．
そして，それが終わった後に知覚情報の読み込みが始まります．
つまり，このログビューワーにおける情報の読み込み作業は，2 段階あるということです．
そのため，知覚情報を表示している状態のままステップを進めると，ヘッダーに表示している読み込み中のステップ数が 0 になる
