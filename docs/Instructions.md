...
| ボタンの表現 | 機能 |
| ----------------------- | ---------- |
| ![](./imgs/StartB.png) | 最初のステップまで戻ります |
| ![](./imgs/BeforeTenB.png) | 10 ステップだけ戻ります |
| ![](./imgs/BeforeOneB.png) | 1 ステップだけ戻ります |
| ![](./imgs/AfterOneB.png) | 1 ステップだけ進みます |
| ![](./imgs/AfterTenB.png) | 10 ステップだけ進みます |
| ![](./imgs/EndB.png) | 最後のステップまで進みます |
...
| ボタンの表現 | 機能 |
| ----------------------- | ---------- |
| ![](./imgs/PerB.png) | 「VIEW PERCEPTION」ボタンによって表示されていた情報が非表示になります |
